...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    ...
    KC_TAB,         LT(4,KC_Q),     LT(5,KC_W),     KC_E,           KC_R,           KC_T,           TT(1),                                          TT(2),          KC_Y,           KC_U,           KC_I,           LT(5,KC_O),     LT(4,KC_P),     KC_BSLASH,
    MO(3),          LT(1,KC_A),     LT(6,KC_S),     KC_D,           KC_F,           KC_G,                                                                           KC_H,           KC_J,           KC_K,           LT(6,KC_L),     LT(1,KC_SCOLON),LT(3,KC_QUOTE),
    KC_LSPO,        LT(2,KC_Z),     LT(7,KC_X),     KC_C,           KC_V,           KC_B,           KC_EQUAL,                                       KC_EQUAL,       KC_N,           KC_M,           KC_COMMA,       LT(7,KC_DOT),   LT(2,KC_SLASH), KC_RSPC,
    LCTL_T(KC_GRAVE),KC_QUOTE,       KC_LALT,        KC_LEFT,        KC_RIGHT,                                                                                                       KC_DOWN,        KC_UP,          RALT_T(KC_LBRACKET),KC_RBRACKET,    KC_RCTRL,
                                                                                                    KC_LGUI,        LCTL(KC_TAB),   KC_LALT,        LCTL_T(KC_ESCAPE),
                                                                                                                    KC_HOME,        KC_PGUP,
                                                                                    KC_LALT,        KC_SPACE,       KC_END,         KC_PGDOWN,      KC_BSPACE,      KC_ENTER
  ),
  [1] = LAYOUT_ergodox_pretty(
    KC_ESCAPE,      KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F5,          KC_END,                                         KC_END,         KC_F6,          KC_F7,          KC_F8,          KC_F9,          KC_F10,         KC_F11,
    ...
    KC_TRANSPARENT, LCTL(KC_1),     KC_TRANSPARENT, KC_V,           LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),   KC_ENTER,                                       KC_ENTER,       LCTL(LSFT(KC_TAB)),LCTL(KC_TAB),   KC_V,           KC_TRANSPARENT, LCTL(KC_9),     TO(0),
    KC_TRANSPARENT, LCTL(KC_KP_MINUS),LCTL(KC_KP_PLUS),KC_LEFT,        KC_RIGHT,                                                                                                       KC_UP,          KC_DOWN,        LCTL(KC_KP_MINUS),LCTL(KC_KP_PLUS),KC_RCTRL,
                                                                                                    KC_LGUI,        KC_TRANSPARENT, LCTL(KC_T),     KC_TRANSPARENT,
                                                                                                                    LCTL(LSFT(KC_T)),LCTL(LSFT(KC_T)),
                                                                                    KC_LCTRL,       KC_LALT,        LCTL(KC_W),     LCTL(KC_W),     KC_WWW_BACK,    KC_WWW_HOME
  ),
  [2] = LAYOUT_ergodox_pretty(
    KC_MEDIA_PLAY_PAUSE,KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_AUDIO_MUTE,  KC_AUDIO_VOL_UP,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    LCTL(KC_GRAVE), LCTL(KC_QUOTE), LCTL(KC_LALT),  LCTL(KC_LEFT),  LCTL(KC_RIGHT),                                                                                                 LCTL(KC_UP),    LCTL(KC_DOWN),  LCTL(KC_LBRACKET),LCTL(KC_RBRACKET),KC_TRANSPARENT,
  ...
  [5] = LAYOUT_ergodox_pretty(
    ...
    KC_LBRACKET,    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RBRACKET,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [6] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_LCBR,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RCBR,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ...
  [7] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
    KC_LABK,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_RABK,
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                                                    KC_TRANSPARENT, KC_TRANSPARENT,
                                                                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
